---
title: "The art of making a data cube"
...
```{r slope, cache=TRUE, warning=FALSE, message=FALSE, collapse=TRUE, eval=TRUE}
...
```{r aspect, cache=FALSE, warning=FALSE, message=FALSE, collapse=TRUE, eval=TRUE}
...
```{r boulder_bounding_box, cache=TRUE, warning=FALSE, message=FALSE, collapse=TRUE}
...
```{r build_collection, cache=FALSE, warning=FALSE, message=FALSE, eval=TRUE, collapse=TRUE}
# Record start time
a <- Sys.time()
...
Saving Data Cubes to Local Storage
