...
```{r build_collection, cache=FALSE, warning=FALSE, message=FALSE, eval=TRUE}
# Record start time
a <- Sys.time()
...
```{r extract_spectra, cache=TRUE, warning=FALSE, message=FALSE}
# Record start time
a <- Sys.time()
...
```{r make_raster_cube, cache=TRUE, warning=FALSE, message=FALSE}
# Record start time
a <- Sys.time()
...
```{r make_STARS_cube, cache=TRUE, warning=FALSE, message=FALSE}
# Record start time
a <- Sys.time()
...
```{r time_series_cube, cache=TRUE, warning=FALSE, message=FALSE}
