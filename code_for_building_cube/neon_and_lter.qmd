---
title: "NEON and LTER macroinverts powered by ecocomDP"
...
```{r load packages, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
...
```{r search data packages, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
...
```{r get neon sites, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
...
```{r download data, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
...
```{r plot space time neon, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
...
```{r plot space time stacked data, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
...
```{r plot taxon ranks neon, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
...
```{r plot taxon ranks stacked data, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
stacked_neon_ntl %>% 
  plot_taxa_rank(
